...
stop_play:
    in      r16,      MCUCR                    ; MCU Control Register
    andi    r16,      0b1000111            ; Masking out Sleep Mode pattern
    ori     r16,      0b0110000            ; ORing in 'Power Down' pattern for Sleep Mode
    out     MCUCR,        r16                  ; Rewrite Register Bits
	outi	DDRB,  0b000000		;/
	;sei
	sleep
	;rjmp stop_play
