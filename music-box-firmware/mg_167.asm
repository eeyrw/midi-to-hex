...
.include "tn167def.inc"	;This is included in "Atmel AVR Studio"
.include "avr.inc"
.include "mg.inc"
...
.cseg
	; Interrupt Vectors (ATtiny167)
	jmp reset ; Reset Handler
	jmp 0 ; IRQ0 Handler
	jmp 0 ; IRQ1 Handler
	jmp 0 ; PCINT0 Handler
	jmp 0 ; PCINT1 Handler
	jmp 0 ; Watchdog Timer Handler
	jmp 0 ; Timer1 Capture Handler
	jmp 0 ; Timer1 Compare A Handler
	jmp 0 ; Timer1 Compare B Handler
	jmp 0 ; Timer1 Overflow Handler
	jmp isr_tc0_coma ; Timer0 Compare A Handler
	jmp 0 ; Timer0 Overflow Handler
	jmp 0 ; LIN Transfer Complete Handler
	jmp 0 ; LIN Error Handler
	jmp 0 ; SPI Transfer Complete Handler
	jmp 0 ; ADC Conversion Complete Handler
	jmp 0 ; EEPROM Ready Handler
	jmp 0 ; Analog Comparator Handler
	jmp 0 ; USI Start Condition Handler
	jmp 0 ; USI Overflow Handler
